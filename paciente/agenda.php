<?php
 ...
 $reg= $p -> mostrarAgenda($id_paciente);
?>
...
<div class="cabecera">
            <div class="subcab1">
                ...
                <div>
                    <h1>Agenda de  <span>citas</span> </h1>
                </div>
            </div>
            <div class="subcab2">
                <div>
...
<tr><th>Visita #</th><th>Hora visita</th><th>Fecha visita</th><th>Especialidad</th><th>Estado</th><th>Cancelar citas</th></tr>
<?php
for($i=0;$i<count($reg);$i++){
 echo "<tr>
  ...
  <td> <button  class='btn btn-info btn-block' href='javascript:void(0)'><i class='far fa-window-close'></i></i>&nbsp; Cancelar </td>
";
}
?>
</table>
