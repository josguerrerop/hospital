...
<body>
    <div class="container">
        ...
        <div class="op">
                ...
                <div class="ima">
                    <a href="verespecialidades.php"><img src="../img/ver.png" alt=""></a>
                </div>
            </div>
            <div class="op">
                <div class="titulo">INSERTAR</div>
                <div class="ima">
                    <a href="insertarespecialidades.php"><img src="../img/escritura.png" alt=""></a>
                </div>
            </div>
            <div class="op">
                <div class="titulo">ELIMINAR</div>
                <div class="ima">
                    <a href="borrarespecialidades.php"><img src="../img/basura.png" alt=""></a>
                </div>
            </div>
        </div>
        <div class="piedpa">
